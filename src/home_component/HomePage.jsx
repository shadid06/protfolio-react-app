    ...
    <div className="  mx-14  ">
      ...
      <div className=" flex flex-row md:flex md:flex-row md:justify-between md:mx-48 my-32">
        <div className=" flex flex-col justify-start">
          <p className=" text-2xl  text-gray-600 font-bold">Hi,</p>
          <p className=" text-2xl  text-gray-600 font-bold">My name is</p>
      ...
      <div className="md:mx-48 mb-20">
        <h4 className=" flex justify-center items-center text-gray-700 font-bold text-2xl mb-1">
          My Tech Stack
        </h4>
        ...
        <div className="mt-10 md:grid md:grid-cols-6 md:gap-20 grid grid-cols-3 gap-10 md:ml-0 ml-6">
          ...
          <img src="/images/mongodb.png" className=" h-16 w-16" />
      ...
      <div className="md:mx-48 mb-20">
        ...
        <div className=" mt-10 md:grid md:grid-cols-3 md:gap-24 grid grid-cols-2 gap-10 ml-6">
          {/* start card */}
          <div className=" h-64 w-40 shadow-lg rounded-md bg-white flex flex-col">
            <img
              src="/images/wall.jpeg"
              className=" z-0 h-20 w-40 rounded-tl-md rounded-tr-md mb-1"
            />
            ...
            <div className=" flex flex-row justify-between mx-2">
              <div className=" flex flex-row space-x-1">
                ...
                <p className=" text-black text-[10px] underline">view source</p>
              </div>
            </div>
          </div>
          {/* end card */}
